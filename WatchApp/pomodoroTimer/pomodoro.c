...
static void DrawProgressBar(uint16_t remaining, uint16_t total) {
...
void Pomodoro_Draw(void) {
    ...
    DrawSessionCounter(state->pomodoro.work_sessions);
    ...
    // Draw progress bar
    DrawProgressBar(state->pomodoro.remaining_seconds, total_seconds);
